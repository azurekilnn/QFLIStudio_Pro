 ...
 */
package com.luastudio.azure.textwarrior.common;
...
public abstract class Language {
  ...
  protected HashMap<String, Integer> _normals= new HashMap<String, Integer>(0);
  private ArrayList<String> _normalCache = new ArrayList<String>();
  private String[] _normalWords=new String[0];

  public void updateNormalWord()
  {
    // TODO: Implement this method
    String[] uw = new String[_normalCache.size()];
    _normalWords = _normalCache.toArray(uw);
  }
  ...
  public final boolean isNormalWord(String s)
  {
    return _normals.containsKey(s);
  }
  ...
  public void addKeyWords(String keyNames[]){
    for(String keyName:keyNames)
    _keywords.put(keyName, Lexer.KEYWORD);
  }

  public void removeKeyWords(String keyNames[]){
    for(String keyName:keyNames)
    _keywords.remove(keyName);
  }
