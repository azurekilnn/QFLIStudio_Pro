...
* ### About Path -> [com.qflistudio.azure.util.PathUtils.java][path.java] -> [Demo][path.demo]
```
join
getRootPath
getDataPath
...
[path.java]: https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/java/com/blankj/utilcode/util/com.qflistudio.azure.util.PathUtils.java
