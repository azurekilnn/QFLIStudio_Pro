...
import com.luastudio.azure.textwarrior.android.*;
import com.luastudio.azure.textwarrior.common.*;

import java.io.*;

public class MyEditor extends FreeScrollingTextField {
    ...
    private String fontDir = LuaApplication.getInstance().getLuaExtPath("fonts");
    private String libDir = LuaApplication.getInstance().getEnvironmentDir("Android") + "/android.jar";
    ...
    public MyEditor(final Context context) {
        super(context);
        mContext = context;
