...
public class MyWebView extends WebView implements LuaGcable {
    ...
    private MyWebView.DownloadBroadcastReceiver mDownloadBroadcastReceiver;
    private HashMap<Long, String[]> mDownload = new HashMap<Long, String[]>();
    private OnDownloadCompleteListener mOnDownloadCompleteListener;
    private LuaAppActivity mContext;
    ...
    public MyWebView(LuaAppActivity context) {
        super(context);
        context.regGc(this);
        mContext = context;
        ...
        addJavascriptInterface(new LuaJavaScriptInterface(context), "luastudio");
        //requestFocus();
    ...
    class JsObject {
        private MyWebView.JsInterface mJs;
    ...
    private class LuaJavaScriptInterface {
        ...
        private LuaAppActivity mMain;

        public LuaJavaScriptInterface(LuaAppActivity main) {
            mMain = main;
        }
    ...
    private class SimpleLuaWebViewClient extends WebViewClient {
        ...
        private MyWebView.LuaWebViewClient mLuaWebViewClient;
